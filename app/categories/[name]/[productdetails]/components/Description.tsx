...
//   const product = {
//     title: "Buchymix 7L Air Fryer",
//     rating: 4.8,
//     reviews: 87,
//     description:
//       "The Buchymix 7L Air Fryer is perfect for quick, healthy meals with less oil. It features adjustable temperature controls, a digital timer, and fast heating for even cooking. Ideal for frying, roasting, baking, and grilling with little to no oil. Large enough to cook for a family of 4–6.",
//     location: "13B Freedom Line, near Samsung Plaza, Alaba Int'l",
//     posted: "2 hours ago",
//     promoted: true,
//   };
...
//       {/* Title */}
//                 <h6 className="text-primary font-[600] text-[27px] md:text-[41px]">{product.title}</h6>
...
//         {product.promoted && (
//           <span className="hidden md:inline px-2 py-1 bg-gray-200 rounded">
//             Promoted
//           </span>
//         )}
//         <span>📍 {product.location}</span>
//         <span className="ml-auto">{product.posted}</span>
//       </div>
//     </div>
//   );
// }
