...
const Report = ({showReport, setShowReport}: ReportProps) => {
    ...
    >
      ...
      <div className="flex flex-col gap-3">
             <div className="flex items-center justify-between w-full">
                    <h2 className="text-primary font-[700] text-[24px]">Report Listing</h2>
...
<p className="hidden md:block text-grey ">
    If something doesn’t look right about this listing, <br /> please tell us why.
</p>
...
<form>
      <div>
        ...
        Choose a reason <span className="text-red">*</span>
      </p>
  ...
  <rect x="0.5" y="0.5" width="25" height="25" rx="12.5" fill="#FEFBF2" stroke="#7C6100"/>
      ...
      <div>
        <label className="block  my-6 font-[500] text-[17px] text-primary">Add more details</label>
        <textarea
          value={details}
          onChange={(e) => setDetails(e.target.value)}
