...
//     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
//    },
//   { name: 'Cable Trays',     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
// },
//   { name: 'Switches & Sockets',     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
//  },
//   { name: 'Refrigerators',    image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
//  },
//   { name: 'Mixer Grinders',     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
//  },
//   { name: 'Fuse & Accessories',     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
// },
//   { name: 'Switchboards & Panels',     image:['/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png','/images/ups.png']
//  },
...
//       <div className="bg-categoryBg py-[48px] px-[12px] rounded-lg grid grid-cols-3 gap-1  sm:grid-cols-3 md:gap-5 md:grid-cols-5  lg:grid-cols-7 ">
...
//         <Link
//           href="/categories"
//           className="text-primary text-[14px] font-semibold underline   gap-2 md:text-[17px]"
//         >
//           View  all 
//         </Link>
//      </div>
