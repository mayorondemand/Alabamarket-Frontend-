...
const reviews = [
  {
    ...
    date: "3 days ago",
    review:
      "Very fast delivery and works perfectly. Fries come out crispy and there’s no smell. Highly recommend seller too, very polite and patient!",
    rating: 5,
    likes: 2,
    comments: 1,
    avatar:
      "https://via.placeholder.com/40", // Replace with actual avatar image URL
  },
   {
    name: "Eze Soporuchi",
    date: "3 days ago",
...
<ReplyReview  showReport={showReport} setShowReport={setShowReport}/>
      {reviews.map((review, idx) => (
        <div
          key={idx}
          className="bg-white rounded-[12px] border-1 border-active p-4 flex flex-col gap-3"
        >
          {/* Top section */}
