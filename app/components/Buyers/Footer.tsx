...
const Footer = () => {
    ...
    const hideFooterRoutes = ["/buyer/chats","/auth/signup",'/seller','/seller/communication','/seller/insights','/seller/reviews','/seller/listings','/seller/ads','/seller/settings','/seller/payments','/seller/notification'];
