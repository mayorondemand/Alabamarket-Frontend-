...
const Footer = () => {
    ...
    const hideFooterRoutes = ["/buyer/chats","/auth/signup",'/seller','/seller/boostad','/seller/communication','/seller/insights','/seller/reviews','/seller/listings','/seller/ads','/seller/settings','/seller/help','/seller/notification'];
