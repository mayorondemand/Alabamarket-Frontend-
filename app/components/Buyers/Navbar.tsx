...
const [showLogout,setShowLogout]=useState(false)
 const hideFooterRoutes = ["/auth/signup",'/seller','/seller/communication','/seller/insights','/seller/reviews','/seller/listings','/seller/ads','/seller/settings','/seller/payments'];
