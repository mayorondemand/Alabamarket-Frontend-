...
return <div className="flex flex-col gap-1 items-center text-center justify-center mt-20 pt-6 md:gap-6 lg:pt-0">
    <h1 className="text-primary text-[33px]   font-[700] leading-[42px] md:text-[52px] ">
Find trusted electronics from Alaba sellers
    </h1>

   <p className="text-description text-[17px] md:text-[21px] ">Built with the Alaba traders in mind. The market is now online.</p>

  <form  onSubmit={(e) => {
    e.preventDefault();
    search();
  }} className="flex flex-1 mt-4 items-center bg-white rounded-md px-3 py-2 mx-auto w-full rounded-[8px] border-[0.6px] border border-inputBorder lg:hidden">
          <input
            type="search"
