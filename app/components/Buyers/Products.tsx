...
>
  ...
  <path d="M7.05566 1C4.01816 1 1.55566 3.4625 1.55566 6.5C1.55566 12 8.05566 17 11.5557 18.163C15.0557 17 21.5557 12 21.5557 6.5C21.5557 3.4625 19.0932 1 16.0557 1C14.1957 1 12.5507 1.9235 11.5557 3.337C11.0484 2.61469 10.3746 2.0252 9.59134 1.61841C8.80805 1.21162 7.93829 0.999502 7.05566 1Z" stroke="#172556" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      {item.fixed&&<div className="flex gap-1 flex-col order-1 md:order-2"><button className="text-sm  flex items-center gap-1 text-description bg-white z-10 hover:bg-white rounded p-1 order-2 md:order-1 "> <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
...
{item.verifiedSeller&&
<button className="text-sm   flex items-center gap-1 text-description bg-white z-10 hover:bg-white rounded p-1 order-1 md:order-2"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
