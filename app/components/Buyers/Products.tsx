...
<Image
  ...
  className={`object-cover w-full h-full ${
    linear
      ...
      : 'rounded-md rounded-tr-none rounded-br-none lg:max-h-[280px]'
  }`}
/>
...
{item.verifiedSeller&&
<button className="text-sm   flex items-center gap-2 text-primary bg-[#DBFCD4] hover:bg-[#DBFCD4] rounded p-2 w-fit"> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 14 12" fill="none">
...
<button className="text-sm  inline-flex items-center gap-2 text-description bg-white  hover:bg-white rounded p-2  w-fit "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 13 12" fill="none">
 ...
 <button
  className=" bg-white h-fit hover:bg-white rounded-lg p-3 shadow-md border border-saveBorder border-2"
