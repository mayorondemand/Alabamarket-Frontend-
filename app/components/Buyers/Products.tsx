...
{item.verifiedSeller&&
<button className="text-sm   flex items-center gap-2 text-primary bg-[#DBFCD4] hover:bg-[#DBFCD4] rounded p-1 w-fit"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 12" fill="none">
...
<button className="text-sm mt-1 inline-flex items-center gap-2 text-description bg-white  hover:bg-white rounded p-1  w-fit "> <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 12" fill="none">
...
{item.name}
   {/* {item.name.length > 35 ? `${!linear?`${item.name}`:`${item.name.substring(0, 35)}...`}` : item.name} */}
</h4>
